...
$, win, ready = {
    ...
    window.layer = {
        ...
        use: function (module, callback) {
            ...
            debugger
            node[iscss ? 'href' : 'src'] = module; // /^http:\/\//.test(module) ? module : layer.path + module;
            node.id = id;
            if (!$('#' + id)[0]) {
    ...
    **/
    ...
    ready.run = function () {
        ...
        debugger
        (new Image()).src = '../../Content/Img/layerskin/xubox_ico0.png';// layer.path + '../Img/layerskin/xubox_ico0.png';
    };
